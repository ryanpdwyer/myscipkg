...
# Check if on READTHEDOCS. If so, we need to mock out our c dependencies
...
version = myscipkg.__version__
# The full version, including alpha/beta/rc tags.
release = myscipkg.__version__
...
latex_documents = [
  ('index', 'myscipkg.tex', u'myscipkg Documentation',
   u'Ryan Dwyer', 'manual'),
]
...
man_pages = [
    ('index', 'myscipkg', u'myscipkg Documentation',
     [u'Ryan Dwyer'], 1)
]
...
texinfo_documents = [
  ('index', 'myscipkg', u'myscipkg Documentation',
   u'Ryan Dwyer', 'myscipkg', 'One line description of project.',
   'Miscellaneous'),
]
